...
export default function RequestPrescriptionPage() {
  ...
  const handleInputChange = (field: keyof RequestForm, value: string | boolean) => {
    setForm(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  return (
    <DashboardLayout title="Request Prescription" description="Request a new prescription from your healthcare provider">
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={(e) => handleInputChange("previouslyTaken", e.target.checked)}
                        className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                      />
                      <span className="text-sm text-gray-700">I have taken this medication before</span>
                    </label>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="text-sm">
                    ...
                    <p className="font-medium text-gray-900 capitalize">{form.requestType.replace('_', ' ')}</p>
                  </div>

                  <div className="text-sm">
                    <p className="text-gray-500">Urgency Level</p>
                    <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getUrgencyColor(form.urgency)}`}>
                  ...
                  {form.medicationName && (
                    <div className="text-sm">
                      ...
                      <p className="font-medium text-gray-900">{form.medicationName}</p>
                    </div>
                  )}
                  ...
                  {form.doctorPreference && (
                    <div className="text-sm">
                      ...
                      <p className="font-medium text-gray-900">{form.doctorPreference}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start space-x-2">
                      ...
                      <p className="text-gray-700">Routine requests are processed within 3-5 business days</p>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-700">You will receive a confirmation email once submitted</p>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-700">Your doctor may contact you for additional information</p>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-orange-600 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-gray-700">For emergencies, call 911 or go to the nearest ER</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            ...
            <Button 
              type="submit" 
              disabled={isSubmitting || !form.medicationName || !form.reasonForRequest}
