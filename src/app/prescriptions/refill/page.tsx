    ...
    switch (step) {
      case 1:
        return (
          <div className="space-y-4">
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Select Prescription to Refill</h2>
              <p className="text-gray-600">Choose which prescription you&apos;d like to request a refill for.</p>
            </div>

            <div className="space-y-3">
              {mockPrescriptions.filter(p => p.refillsRemaining > 0).map((prescription) => (
                <div key={prescription.id} className="bg-white border border-gray-200 rounded-lg shadow-sm cursor-pointer hover:shadow-md transition-shadow" onClick={() => handlePrescriptionSelect(prescription)}>
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Dr. {prescription.prescribingDoctor}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm font-medium text-gray-900">{prescription.refillsRemaining} refills left</p>
                        <p className="text-xs text-gray-500">{prescription.currentPharmacy}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {mockPrescriptions.filter(p => p.refillsRemaining > 0).length === 0 && (
              <div className="text-center py-8">
                <ExclamationTriangleIcon className="w-16 h-16 text-gray-300 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-gray-900 mb-2">No Refills Available</h3>
                <p className="text-gray-500">You don&apos;t have any prescriptions with remaining refills.</p>
              </div>
            )}
          </div>
        );
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Refill Details</h2>
              <p className="text-gray-600">Specify your refill preferences and delivery options.</p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg">
              <div className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">{selectedPrescription?.medicationName}</h3>
                    <p className="text-sm text-gray-600">{selectedPrescription?.dosage}</p>
                    <p className="text-sm text-gray-500">{selectedPrescription?.refillsRemaining} refills remaining</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, requestedQuantity: parseInt(e.target.value) || 0 }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  min="1"
                />
                <p className="text-xs text-gray-500 mt-1">Standard quantity: {selectedPrescription?.quantityPrescribed}</p>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, urgency: e.target.value as "routine" | "urgent" | "emergency" }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, deliveryMethod: e.target.value as "pickup" | "delivery" | "mail" }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
                  <option value="IEHP Pharmacy - Riverside">IEHP Pharmacy - Riverside</option>
                  <option value="IEHP Pharmacy - San Bernardino">IEHP Pharmacy - San Bernardino</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, contactMethod: e.target.value as "phone" | "email" | "portal" }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={formData.contactMethod === 'phone' ? 'Phone number' : formData.contactMethod === 'email' ? 'Email address' : 'Portal notifications'}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            </div>
      ...
      case 3:
        return (
          <div className="space-y-6">
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Review Your Refill Request</h2>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{formData.requestedQuantity} tablets</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium capitalize">{formData.deliveryMethod}</p>
                  </div>
                  <div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    Your refill request will be processed within the timeframe specified by your urgency level. 
                    You will receive confirmation once your pharmacy has prepared your medication.
                  </p>
                </div>
              </div>
            </div>
      ...
      case 4:
        return (
          <div className="text-center py-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Refill Request Submitted!</h2>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Your refill request for {formData.medicationName} has been successfully submitted. 
              You will receive confirmation within {formData.urgency === 'emergency' ? '2 hours' : formData.urgency === 'urgent' ? '24 hours' : '2-3 business days'}.
            </p>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div className={`flex items-center ${step >= 1 ? 'text-blue-600' : 'text-gray-400'}`}>
                ...
                <span className="ml-2 text-sm font-medium">Select Prescription</span>
              </div>
