...
const mockLabResults: LabResult[] = [
  {
    ...
    result: "Normal",
    doctorNotes:
      "All values within normal range. Continue current lifestyle habits.",
  ...
  },
  {
    ...
    doctorNotes:
      "Cholesterol levels are slightly above normal. Recommend dietary changes and follow-up in 3 months.",
    doctorName: "Dr. Sarah Wilson",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    result: "Low",
    doctorNotes:
      "Vitamin D deficiency detected. Prescribed supplements. Recheck in 6 weeks.",
...
const getResultColor = (result: string) => {
  ...
  if (result === "Low" || result === "High" || result.includes("Elevated"))
...
export default function LabResultsPage() {
  ...
  const completedResults = mockLabResults.filter(
    (result) => result.status === "completed"
  );
  const pendingResults = mockLabResults.filter(
    (result) => result.status !== "completed"
  );
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-gray-500 mb-6">
              Your test results will appear here once they&apos;re available
            </p>
