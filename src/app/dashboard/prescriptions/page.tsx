...
export default function PrescriptionsPage() {
  ...
  const [filter, setFilter] = useState<
    "all" | "active" | "pending_refill" | "completed" | "expired"
  >("all");
  ...
  const pendingRefills = mockPrescriptions.filter(
    (rx) => rx.status === "pending_refill"
  );
  const needingRefill = mockPrescriptions.filter(
    (rx) => rx.refillsRemaining <= 1 && rx.status === "active"
  );
    ...
    >
      ...
      <div className="flex justify-between items-center mb-6 sm:mb-8">
        ...
        <div className="ml-auto flex flex-col sm:flex-row gap-2 sm:gap-3">
          <Link href="/dashboard/prescriptions/refill">
            <Button
              variant="outline"
          ...
          <Link href="/dashboard/prescriptions/request">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="font-medium text-gray-900">
                        {prescription.pharmacyName || "Not selected"}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col space-y-2 ml-6">
                  ...
                  {prescription.status === "active" &&
                    prescription.refillsRemaining > 0 && (
                      <Link
                        href={`/dashboard/prescriptions/refill?id=${prescription.id}`}
                      >
