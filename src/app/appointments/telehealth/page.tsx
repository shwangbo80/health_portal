      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Start Video Call</h3>
            <p className="text-sm text-gray-600 mb-4">Join your scheduled appointment</p>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Schedule Telehealth</h3>
            <p className="text-sm text-gray-600 mb-4">Book a virtual appointment</p>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">Check your audio and video</p>
        ...
        <CardContent>
          {upcomingTelehealth.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No telehealth appointments</h3>
              <p className="text-gray-500 mb-4">You don&apos;t have any upcoming virtual appointments scheduled</p>
              <Link href="/appointments/book">
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Before Your Appointment</h4>
              <ul className="space-y-2 text-sm text-gray-600">
